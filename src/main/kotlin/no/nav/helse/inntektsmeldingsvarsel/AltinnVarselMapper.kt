...
class AltinnVarselMapper(val altinnTjenesteKode: String) {
    ...
    private fun opprettManglendeInnsendingNotifications(): NotificationBEList {
        val epost = opprettEpostNotification(
            ...
            "<p>NAV mangler inntektsmelding for en eller flere av deres ansatte i \$reporteeName\$. Vi får ikke utbetalt penger før inntektsmeldingen er sendt. " +
                "Gå til meldingsboksen i Altinn for å se hvem det gjelder, og hvilken periode det handler om.</p>" +
    ...
    fun mapVarslingTilInsertCorrespondence(altinnVarsel: Varsling): InsertCorrespondenceV2 {
        ...
        val innhold = """
            <html>
               ...
               <body>
                   <div class="melding">
                        <p>NAV mangler inntektsmelding for ansatte ved virksomheten (${altinnVarsel.virksomhetsNr}).
                         For at vi skal kunne vurdere retten til sykepenger det søkes om må inntektsmelding sendes oss så snart som mulig.
                         Dere kan se bort fra varselet hvis dere har sendt inntektsmelding i løpet av de siste 24 timene for disse ansatte:</p>
            ...
            """.trimIndent()
                       ...
                       <p>Denne meldingen er automatisk generert og skal hjelpe arbeidsgivere med å få oversikt over inntektsmeldinger som mangler.
                        NAV påtar seg ikke ansvar for eventuell manglende påminnelse.
                       Vi garanterer heller ikke for at foreldelsesfristen ikke er passert, eller om det er andre grunner til at retten til sykepenger ikke er oppfylt.
                       Dersom arbeidstakeren har åpnet en søknad og avbrutt den, vil det ikke bli sendt melding til dere.</p>
                   </div>
               </body>
            </html>
        """.trimIndent()
